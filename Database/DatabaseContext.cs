...
namespace SolarisBot.Database
{
    internal sealed class DatabaseContext : DbContext
    {
        ...
        public override Task<int> SaveChangesAsync(CancellationToken cancellationToken = default) //todo: handle modified and added via db too, cascading soft delete?
        {
