            ...
            try
            {
                ...
                if (version < 1)
                {
                    queries.AddRange(new List<string>()
                    {
                        ...
                        "CREATE TRIGGER GuildConfigsSetModified BEFORE UPDATE ON GuildConfigs FOR EACH ROW BEGIN SET New.UpdatedAt = strftime('%s', 'now', 'utc'); END",
                        ...
                        "CREATE TRIGGER RoleGroupsSetModified BEFORE UPDATE ON RoleGroups FOR EACH ROW BEGIN SET New.UpdatedAt = strftime('%s', 'now', 'utc'); END",
                        ...
                        "CREATE TRIGGER RoleConfigsSetModified BEFORE UPDATE ON RoleConfigs FOR EACH ROW BEGIN SET New.UpdatedAt = strftime('%s', 'now', 'utc'); END",
                        ...
                        "CREATE TRIGGER QuotesSetModified BEFORE UPDATE ON Quotes FOR EACH ROW BEGIN SET New.UpdatedAt = strftime('%s', 'now', 'utc'); END",
                        ...
                        "CREATE TRIGGER JokeTimeoutsSetModified BEFORE UPDATE ON JokeTimeouts FOR EACH ROW BEGIN SET New.UpdatedAt = strftime('%s', 'now', 'utc'); END",
                        ...
                        "CREATE TRIGGER RemindersSetModified BEFORE UPDATE ON Reminders FOR EACH ROW BEGIN SET New.UpdatedAt = strftime('%s', 'now', 'utc'); END",
                        ...
                        "CREATE TRIGGER BridgesSetModified BEFORE UPDATE ON Bridges FOR EACH ROW BEGIN SET New.UpdatedAt = strftime('%s', 'now', 'utc'); END",
                        ...
                        "CREATE TRIGGER RegexChannelsSetModified BEFORE UPDATE ON RegexChannels FOR EACH ROW BEGIN SET New.UpdatedAt = strftime('%s', 'now', 'utc'); END",
                    });
                    migrationVersion = 1;
                }
